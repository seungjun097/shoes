							...
							<div class="col-md-12 text-center">
								<div class="block-27">
					               <ul>
						               <c:choose>
							               <c:when test="${page==0}">
								                <li><a href="item?cmd=womanlist&page=${page-1}"><i class="ion-ios-arrow-back"></i></a></li>
								           </c:when>
								           <c:otherwise>
								           		<li><a href="item?cmd=womanlist&page=${page-1}"><i class="ion-ios-arrow-back" ></i></a></li>
								           </c:otherwise>
						                ...
						                <c:choose>
							               <c:when test="${page==lastpage}">
								                <li><a href="item?cmd=womanlist&page=${page+1}"><i class="ion-ios-arrow-forward"></i></a></li>
								           </c:when>
								           <c:otherwise>
								           		<li><a href="item?cmd=womanlist&page=${page+1}"><i class="ion-ios-arrow-forward" ></i></a></li>
								           </c:otherwise>
